...
uint8_t esp_vp_led_brightness(void);
...
void esp_vp_diag_record_ssdp_search(void);
void esp_vp_diag_record_ssdp_response(void);
void esp_vp_diag_record_bind_accept(void);
void esp_vp_diag_record_mqtt_accept(void);
void esp_vp_diag_record_ftps_accept(void);
void esp_vp_diag_record_upload_success(void);
uint32_t esp_vp_diag_ssdp_searches(void);
uint32_t esp_vp_diag_ssdp_responses(void);
uint32_t esp_vp_diag_bind_accepts(void);
uint32_t esp_vp_diag_mqtt_accepts(void);
uint32_t esp_vp_diag_ftps_accepts(void);
uint32_t esp_vp_diag_upload_successes(void);
